...
timeSteps=[[0 for x in range(10)] for y in range(80)] 
newAnswer=answer[9::1]
x=0
for x in range(0,len(mom)-9):
    for i in range(10):
        x=x+1
        print("Mom ",mom[x+i])
        timeSteps[x][i]=mom[x*10+i]
...
model.fit(mom[14::1],answer[14::1],epochs=1000000)
