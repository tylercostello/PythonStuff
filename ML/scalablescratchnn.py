...
print(np.dot(sigprime(np.dot(sig(np.dot(input,l1w)),l2w)).T,sig(np.dot(input,l1w))))
print("DW and DX")
#dw and dx
#print(np.multiply(l2w,np.dot(sigprime(np.dot(sig(np.dot(input,l1w)),l2w)),np.dot(input,sigprime(np.dot(input,l1w)))).T))
print(np.multiply(l2w,np.dot(sigprime(np.dot(sig(np.dot(input,l1w)),l2w)).T,np.dot(input,sigprime(np.dot(input,l1w)))).T))

print("Gradient")
yz=np.dot(sigprime(np.dot(sig(np.dot(input,l1w)),l2w)).T,sig(np.dot(input,l1w)))
flattenWX=np.multiply(l2w,np.dot(sigprime(np.dot(sig(np.dot(input,l1w)),l2w)).T,np.dot(input,sigprime(np.dot(input,l1w)))).T).T
